...
CAEmitterLayer *addEmitterLayer(UIView *view,UIView *window)
{
    ...
    // 星星粒子
    NSBundle *bundle = [NSBundle bundleForClass:[RewardSuccess class]];
    NSURL *bundleURL = [bundle URLForResource:@"success_star" withExtension:@"bundle"];
    bundle = [NSBundle bundleWithURL:bundleURL];
    NSString *path = [bundle pathForResource:@"success_star@2x" ofType:@"png"];
    UIImage *image = [UIImage imageWithContentsOfFile:path];
    CAEmitterCell *subCell4 = subCell(image);
    subCell4.name = @"star";
